...
*/
export default /* @ngInject */['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider.state('wechattab',
    {
      url: '/wechattab',
      abstract: true,
      template: require('../shared/views/wechattab.view.html')
    }
  );
